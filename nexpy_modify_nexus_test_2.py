...
outpath = '/dls/science/users/spc93/misc_nexus_data/modified/tmp/'
filenum = 815893
...
with n.nxfile:
   ...
   n['entry1/diffraction'] = nx.NXsubentry(definition = 'NXmx')
   del n['/entry1/definition']
   n['entry1/diffraction/instrument'] = nx.NXlink(n['/entry1/instrument'])
   #n['entry1/diffraction/instrument'] = n['/entry1/instrument'] ## fails
   #n['entry1/diffraction/instrument/BeamOK'] = n['/entry1/instrument/BeamOK'] ## fails
   #del n['/entry1/instrument'] # this works
   #n.copy('/entry1/instrument', 'entry1/diffraction/instrument') ## fails
...
#### this works (moving field) - move in nexpy doesn't seem to work ### but no longer needed
#import h5py 
#tmp = h5py.File('%s%i.nxs' %  (outpath, filenum),'r+')
#tmp.move('/entry1/instrument', 'entry1/diffraction/instrument')
#tmp.close()
