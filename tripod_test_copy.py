...
print 'Test: calculate angles and tool point coordinates for particular slide translations, then carry out the reverse calculation to check that the translations are the original values before moving'
print '\nCarries out translations in 1mm steps\n'
# X, Y = [caget("BL16I-MO-KBML-02:X1.RBV"),caget("BL16I-MO-KBML-02:X2.RBV"),caget("BL16I-MO-KBML-02:X3.RBV")], [caget("BL16I-MO-KBML-02:Y1.RBV"),caget("BL16I-MO-KBML-02:Y2.RBV"),caget("BL16I-MO-KBML-02:Y3.RBV")]
X, Y = [0, 0, 0], [0, 0, 0]
...
print 'X coords of base translations to be applied: %.5f %.5f %.5f' % tuple(X), '\nY coords of base translations to be applied: %.5f %.5f %.5f' % tuple(Y)
C, alpha = tp.ctool(X, Y)
